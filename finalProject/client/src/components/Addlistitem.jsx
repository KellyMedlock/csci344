...
export default function Addlistitem({ setPageType }) {
    ...
    return (
        <button onClick={showCreateSheet} className="w-full h-24 border-b flex justify-center items-center bg-[#C3C8C9] text-7xl hover:shadow-md shadow-[#18191A80] cursor-pointer">
