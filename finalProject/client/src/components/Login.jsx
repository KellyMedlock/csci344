...
export default function Login() {
    return(
        <div className='bg-[#AAACAD] flex flex-col items-center py-20 px-12 rounded-3xl shadow-2xl shadow-[#59D5FFC0] text-[#091519] hidden'>
            <img src="" alt="logo" className='w-24 h-24 border mb-14' />
            <form action="submit" className='flex flex-col items-center gap-9'>
                <input type="text" placeholder='Username' className='bg-white placeholder-[#091519] rounded-2xl h-11 w-64 pl-5 focus:shadow-inner focus:outline-none shadow-[#545657]' />
